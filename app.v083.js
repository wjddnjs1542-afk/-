...
async function navigateRecommended(){
 ...
 }catch(e){showApproximateRoute(currentPosition,{lat,lng},name,e);toast(e.status==='REQUEST_DENIED'?'Directions API 설정이 필요합니다. 임시 직선 경로를 표시했습니다.':'실제 경로를 찾지 못해 임시 직선 경로를 표시했습니다.')}
}
